...
public final class ReceiverHelper {
     ...
     * @throws Exception
     */
    public static void preLoadReceiver(Context context, File apkFile) throws Exception {
        ...
        //获取插件的classLoader
        ClassLoader cl = CustomClassLoader.getPluginClassLoader(apkFile, packageName);
        ...
        for (Object receiver : receivers) {
            ...
            for (IntentFilter intentFilter : filters) {
                ActivityInfo activityInfo =  (ActivityInfo) RefInvoke.getFieldObject(receiver, "info");

                BroadcastReceiver broadcastReceiver = (BroadcastReceiver) cl.loadClass(activityInfo.name).newInstance();
